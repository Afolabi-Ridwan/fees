...
import vectorImg from "/assets/image/Vector 12.png"
...
const WhoYouAreSection = () => {
    return (
        <section className="whoYouAreSection my-4 lg:px-20 md:px-10  px-6 py-8 w-[100%] relative">
            <img src={vectorImg} alt="" className="md:w-[350px] w-[210px] absolute right-0 top-0 " />
            ...
            <div className="w-[100%] flex max-md:flex-col mt-8">
                <div className="md:w-[50%] w-[100%]">
                    <img src={displayImg} alt="" className="w-[100%] md:h-[auto] rounded-[10px] h-[550px] object-cover object-top" />
                </div>
